...
An update to Cordova Music Controls plugin to support Capacitor 6+
...
I have also bumped the version to version 6, to hopefully stay alongside Capacitor's version.
